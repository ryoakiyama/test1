...
public class BuyItemConfirmAction extends ActionSupport implements SessionAware {
	...
	public String execute() throws SQLException {
		...
		for(int i=0; i<idList.length;i++){
			...
			dto.setItemName(String.valueOf(itemPriceList[i]));
			...
			dto.setUserMasterId(String.valueOf(countList[i]));
			...
			System.out.println("ITEMNAME         :"+dto.getItemName());
			System.out.println("ITEMSTOCK        :"+dto.getCount());
			System.out.println("COUNT            :"+dto.getTotalPrice());
			System.out.println("TOTALPRICE       :"+dto.getTotalCount());
			System.out.println("TOTALCOUNT       ;"+dto.getUserMasterId());
			System.out.println("USERMASTERID     ;"+dto.getPay());
