...
public class LoginAction extends ActionSupport {
	...
	private List<LoginDTO> hako = new ArrayList<LoginDTO>();
	...
	public String execute(){
		...
		hako = dao.select(username, password);

		if(this.username.equals(hako.get(0).getUsername())&&
		this.password.equals(hako.get(0).getPassword())){
			ret = SUCCESS;
		}else{
			ret=ERROR;
		}
